...
public final class CarreraRepositoryImpl extends BaseRepository<Carrera> implements CarreraRepository {
    ...
    private EntityManager em = Persistence.createEntityManagerFactory("Integrador3").createEntityManager();
    ...
    private boolean exist ( Carrera c ) {
        return this.find( c.getId_carrera() ) != null;
    }
    ...
    public List<CarreraDto> findAllByInscriptosOrderByCount() {
        String sql =
                "SELECT new CarreraDto( c.id_carrera, c.nombre, count(*) ) FROM Carrera c"+
    ...
    public List<CarreraReportDto> report() {
        String query =
                ...
                "ORDER BY c.nombre, year(fechaIngreso), year(fechaEgreso) ";
